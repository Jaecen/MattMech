namespace Battletech
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.MechTonnageUpDown = new System.Windows.Forms.NumericUpDown();
			...
			this.InnerSphereNameTextBox = new Battletech.WatermarkTextBox();
			this.ClanNameTextBox = new Battletech.WatermarkTextBox();
			...
			((System.ComponentModel.ISupportInitialize)(this.MechTonnageUpDown)).BeginInit();
			...
			this.FactionCheckBox.CheckedChanged += new System.EventHandler(this.FactionCheckBox_CheckedChanged);
			// 
			// FactionGroupBox
			// 
			...
			this.MechWeightGroupBox.Controls.Add(this.MechTonnageUpDown);
			...
			// MechTonnageUpDown
			// 
			this.MechTonnageUpDown.Enabled = false;
			this.MechTonnageUpDown.Increment = new decimal(new int[] {
            5,
            0,
            0,
            0});
			this.MechTonnageUpDown.Location = new System.Drawing.Point(161, 66);
			this.MechTonnageUpDown.Minimum = new decimal(new int[] {
            20,
            0,
            0,
            0});
			this.MechTonnageUpDown.Name = "MechTonnageUpDown";
			this.MechTonnageUpDown.ReadOnly = true;
			this.MechTonnageUpDown.Size = new System.Drawing.Size(61, 20);
			this.MechTonnageUpDown.TabIndex = 26;
			this.MechTonnageUpDown.Value = new decimal(new int[] {
            20,
            0,
            0,
            0});
			...
			this.AssualtMechRadio.CheckedChanged += new System.EventHandler(this.AssualtMechRadio_CheckedChanged);
			// 
			// HeavyMechRadio
			// 
			...
			this.HeavyMechRadio.CheckedChanged += new System.EventHandler(this.HeavyMechRadio_CheckedChanged);
			// 
			// MediumMechRadio
			// 
			...
			this.MediumMechRadio.CheckedChanged += new System.EventHandler(this.MediumMechRadio_CheckedChanged);
			// 
			// LightMechRadio
			// 
			...
			this.LightMechRadio.CheckedChanged += new System.EventHandler(this.LightMechRadio_CheckedChanged);
			// 
			// YearRatingCheckBox
			// 
			...
			this.YearRatingCheckBox.CheckedChanged += new System.EventHandler(this.YearRatingCheckBox_CheckedChanged);
			// 
			// YearRatingGroupBox
			// 
			...
			// 
			this.BattlemechNameGroupBox.Controls.Add(this.InnerSphereNameTextBox);
			this.BattlemechNameGroupBox.Controls.Add(this.ClanNameTextBox);
			...
			// 
			// InnerSphereNameTextBox
			// 
			this.InnerSphereNameTextBox.Location = new System.Drawing.Point(115, 48);
			this.InnerSphereNameTextBox.Name = "InnerSphereNameTextBox";
			this.InnerSphereNameTextBox.Size = new System.Drawing.Size(205, 20);
			this.InnerSphereNameTextBox.TabIndex = 15;
			this.InnerSphereNameTextBox.WatermarkText = "Enter Inner Sphere Name";
			// 
			// ClanNameTextBox
			// 
			this.ClanNameTextBox.Location = new System.Drawing.Point(115, 22);
			this.ClanNameTextBox.Name = "ClanNameTextBox";
			this.ClanNameTextBox.Size = new System.Drawing.Size(205, 20);
			this.ClanNameTextBox.TabIndex = 15;
			this.ClanNameTextBox.WatermarkText = "Enter Clan Name";
			// 
			// MainForm
			// 
			...
			((System.ComponentModel.ISupportInitialize)(this.MechTonnageUpDown)).EndInit();
        ...
        private System.Windows.Forms.NumericUpDown MechTonnageUpDown;
		...
		private WatermarkTextBox InnerSphereNameTextBox;
		private WatermarkTextBox ClanNameTextBox;
    }
}
